          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan inDesa (DEMO)</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <h6></h6>
                <div class="sub-title">Login untuk gunakan inDesa (DEMO) </div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
