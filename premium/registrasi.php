...
<head>
  ...
  <style>
    body {
      background: url('img/premiumbg.png');
              ...
              <div class="card-body">
                <form method="POST">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" name="nama-desa" class="form-control" placeholder="Nama Desa" autocomplete="off" required>
                  </div>
                  ...
                  <button type="submit" name="sign-up" target="_blank" class="btn btn-primary">Sign up</button>
                </form>
              </div>
            </div>
            <div class="img"></div>
